...
public class ImgSplitter extends javax.swing.JFrame {
  ...
  public ImgSplitter() throws IOException {
    setIconImage(
      Toolkit
        .getDefaultToolkit()
        .getImage(ImgSplitter.class.getResource("/images/icon.png"))
    );
  ...
  private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    ComboBoxLanguage.translateMessageDialog(
      obj,
      "title_clear_message",
      "msg_clear_message",
      idioma.getLanguage()
  ...
  void convertir() {
    ...
    if (split.isSelected()) {
      try {
        ...
        if (
          sizeX.getValue().toString().isEmpty() ||
          sizeY.getValue().toString().isEmpty()
        ) {
          error = true;
          ...
          for (int j = 0; j < row; j++) {
            for (int i = 0; i < column; i++) {
              ...
              File outputfile = new File(
                ...
                subCount +
                "." +
                format.getSelectedItem().toString().toLowerCase()
              );
        ...
        .mergeImage(
            ...
            Metodos
              .obtenerParametrosApi(
                "test." + Metodos.extraerExtension(path.getText())
              )
              .get(0),
            sizeY.getValor(),
            sizeX.getValor()
  ...
  public void initComponents() throws IOException {
    ...
    format.setModel(
      new javax.swing.DefaultComboBoxModel(new String[] { "PNG", "JPG" })
    );

    btnBrowse_1_2_2 = new ButtonRoundedWithImage();

    btnBrowse_1_2_2.addActionListener(
      new ActionListener() {
    ...
    btnBrowse_1_1_4.addEventSelected(
      new EventSwitchSelected() {
    ...
    btnNewButton.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/icon.png"))
    );
          ...
          try {
            ...
            try {
              format.setSelectedItem(
                Metodos.extraerExtension(path.getText()).toUpperCase()
              );
            } catch (Exception e1) {}
          } catch (Exception e1) {}
        }
    ...
    btnBrowse.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/folder.png"))
    );
    ...
    lblSizeX.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/height.png"))
    );
    ...
    lblSizeY.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/width.png"))
    );
    ...
    btnBrowse_1_1.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(1);
    ...
    btnBrowse_1_1.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/1.png"))
    );
    ...
    btnBrowse_1_1_1.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(2);
    ...
    btnBrowse_1_1_1.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/2.png"))
    );
    ...
    btnBrowse_1_1_2.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(2);
          sizeX.setValor(3);
    ...
    btnBrowse_1_1_2.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/3.png"))
    );
    ...
    btnBrowse_1_1_3.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(3);
    ...
    btnBrowse_1_1_3.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/4.png"))
    );
    ...
    btnBrowse_1_1_1_1.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(2);
    ...
    btnBrowse_1_1_1_1.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/5.png"))
    );
    ...
    btnBrowse_1_1_1_2.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(4);
    ...
    btnBrowse_1_1_1_2.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/7.png"))
    );
    ...
    btnBrowse_1_1_1_2_1.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(3);
          sizeX.setValor(1);
    ...
    btnBrowse_1_1_1_2_1.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/6.png"))
    );
    ...
    btnBrowse_1_1_1_2_2.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/8.png"))
    );
    btnBrowse_1_1_1_2_2.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          sizeY.setValor(3);
          sizeX.setValor(2);
    ...
    lblNewLabel.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/crop.png"))
    );

    JLabel lblNewLabel_1 = new JLabel("");
    lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
    lblNewLabel_1.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/merge_files.png"))
    );
          ...
          public void filesDropped(java.io.File[] archivos) {
            ...
            for (File f : archivos) {
              if (i == 0) {
                ...
                if (
                  Metodos
                    .extraerExtension(f.getAbsolutePath())
                    .equals(extension)
                ) {
                  archivosDrag.add(f);
                }
              ...
              archivosDrag
                ...
                .substring(
                  ...
                  archivosDrag
                    .get(0)
                    .getAbsolutePath()
                    .lastIndexOf(Metodos.saberSeparador())
                );
            ...
            try {
              format.setSelectedItem(
                Metodos
                  .extraerExtension(archivosDrag.get(0).getAbsolutePath())
                  .toUpperCase()
              );
            } catch (Exception e) {}
          }
    ...
    idioma.box.addItemListener(
      new ItemListener() {
        public void itemStateChanged(ItemEvent e) {
          if (contador % 2 == 0) {
            try {
              Metodos.escribirFichero(
                archivoTxt,
                new ArrayList<String>(
                  Arrays.asList("" + idioma.box.getSelectedIndex())
                )
              );
            } catch (Exception e1) {}
    ...
    btnBrowse_1_2.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          try {
    ...
    btnBrowse_1_2.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/abrir.png"))
    );
    ...
    btnBrowse_1_2_1.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          try {
    ...
    btnBrowse_1_2_2.setIcon(
      new ImageIcon(ImgSplitter.class.getResource("/images/clean.png"))
    );
  ...
  private void traducir() {
    ComboBoxLanguage.translateDragAndDrop(
      drgndrpDragAndDrop,
      "draganddrop",
      idioma.getLanguage()
    );
    ...
    ComboBoxLanguage.translateJlabel(
      lblDestination,
      "destination",
      idioma.getLanguage()
    );
    ...
    ComboBoxLanguage.translateRadioButtonCustom(
      split,
      "split",
      idioma.getLanguage()
    );
    ...
    ComboBoxLanguage.translateButtonRoundedWithImage(
      btnBrowse,
      "browse",
      idioma.getLanguage()
    );
    ...
    sizeX.setLabelText(
      ComboBoxLanguage.translateString("columns", idioma.getLanguage())
    );

    sizeY.setLabelText(
      ComboBoxLanguage.translateString("rows", idioma.getLanguage())
    );
  }
}
